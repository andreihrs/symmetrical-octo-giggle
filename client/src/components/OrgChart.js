        ...
        <ul className="flex justify-center">
          <li className="prev-bosses prev-selected">
            ...
            >
              ...
              {!display ? (
                <SeeMoreButton onClick={handleSeeMore1} />
              ) : (
                <ul className="selected">
                  <li>
                    <OrgChartProfile name={"Mary Johnson"} title={"CFO"} />
                    <ul></ul>
                  </li>
                  <li>
                    <OrgChartProfile
                    ...
                    >
                      ...
                      {!display2 ? (
                        <ul className="selected">
                          <div class="w-full">
                            <SeeMoreButton
                              onClick={(event) => handleSeeMore2(event)}
                            />
                          </div>
                        </ul>
                      ) : (
                        <ul
                          className={`${
                            display2 ? "selected justify-center" : "hidden"
                          }`}
                        >
                          <li>
                            <OrgChartProfile
                  ...
                  <li>
                    ...
                    {display2 ? (
                      ...
                      <ul
                        className={`${
                          display2 ? "border selected justify-center" : "hidden"
                        }`}
                      >
                        <li>
                          <OrgChartProfile
