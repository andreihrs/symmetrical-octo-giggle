        ...
        <div className="mt-12 pt-12 border-t-2 border-gray-100 grid gap-16 lg:grid-cols-3 lg:col-gap-5 lg:row-gap-12">
          ...
          <div>
            ...
            <div className="mt-6 flex items-center">
              <div className="flex-shrink-0">
                <img alt="Paul York" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" className="h-10 w-10 rounded-full"/>
              </div>
              <div className="ml-3">
