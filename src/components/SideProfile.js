  ...
  return (
    <div className="absolute flex flex-col w-64 inset-y-0 right-0 border-l border-gray-200 shadow-xs">
      <div className="relative w-full text-gray-400 focus-within:text-gray-600">
        ...
        <input id="search_field" className="block w-full h-full pl-8 pr-3 py-2 rounded-xs text-gray-900 placeholder-gray-500 border focus:outline-none focus:placeholder-gray-400 sm:text-sm" placeholder="Search" type="search" />
      </div>
      <div className="pl-2">
